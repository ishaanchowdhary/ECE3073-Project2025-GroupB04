...
MEM_0 := PROJECT_SYS_V2_onchip_memory2_0
...
$(MEM_1)_HIERARCHICAL_PATH := sdram_pll
$(MEM_1)_WIDTH := 16
...
.PHONY: sdram_pll
sdram_pll: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
