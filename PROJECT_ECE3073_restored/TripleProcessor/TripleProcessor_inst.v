	TripleProcessor u0 (
		...
		.p0_in_export         (<connected-to-p0_in_export>),         //         p0_in.export
		.p0_out_export        (<connected-to-p0_out_export>),        //        p0_out.export
		.p1_in_export         (<connected-to-p1_in_export>),         //         p1_in.export
		.p1_out_export        (<connected-to-p1_out_export>),        //        p1_out.export
		.p2_in_export         (<connected-to-p2_in_export>),         //         p2_in.export
		.p2_out_export        (<connected-to-p2_out_export>),        //        p2_out.export
